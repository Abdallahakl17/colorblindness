      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextField(
                controller: nameContoller, labelText: AppString.userName),
            SizedBox(
              height: 16.h,
            ),
            CustomTextField(
            ...
            CustomTextField(
                controller: passwordContoller, labelText: AppString.password),
            SizedBox(
              height: 16.h,
            ),
            CustomTextField(
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Routes.navigateTo(context: context, widget: SingUpScreen());
                  },
                  child: Padding(
                    padding: EdgeInsets.symmetric(
