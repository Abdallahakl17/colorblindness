...
import 'package:color_blindness/presentaions/screens/home_page/main/test/framsworth_lanntern_test/framsworth_test.dart';
  ...
  Widget build(BuildContext context) {
    List<TextContainerTest> texts = [
      ...
      TextContainerTest(
          ...
          onPressed: () {
            Routes.navigateTo(
                context: context, widget:   FramsworthTest());
          }),
      TextContainerTest(
